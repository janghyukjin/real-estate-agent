...
# 페이지 설정
# ─────────────────────────────────────
st.set_page_config(page_title="혁진이의 우당탕탕 내집마련 AI 비서", page_icon="🏠", layout="wide")
st.title("🏠 혁진이의 우당탕탕 내집마련 AI 비서")
...
**내집마련 AI 비서**는 무주택 실수요자를 위한 **아파트 맞춤 추천 도구**입니다.
